...
class Database {
    ...
    companion object {
        ...
        const val CREATE_TABLE_QUERY =
            "CREATE TABLE $TABLE_NAME ($COLUMN_USER_ID LONG PRIMARY KEY, $COLUMN_USER_NAME TEXT NOT NULL, $COLUMN_USER_AVATAR BLOB, $COLUMN_REPUTATION LONG DEFAULT(0), $COLUMN_LAST_ACCESS_DATE LONG DEFAULT(0), $COLUMN_LOCATION TEXT NOT NULL)"
